...
typedef enum {
    ...
    XGU_SHORT = NV097_SET_VERTEX_DATA_ARRAY_FORMAT_TYPE_S32K,
...
typedef enum {
    ...
    XGU_POINT_SIZE_ARRAY = NV2A_VERTEX_ATTR_POINT_SIZE,
...
typedef enum {
    XGU_BLEND_EQUATION_FUNC_ADD = NV097_SET_BLEND_EQUATION_V_FUNC_ADD,
    XGU_BLEND_EQUATION_FUNC_SUBTRACT = NV097_SET_BLEND_EQUATION_V_FUNC_SUBTRACT,
    XGU_BLEND_EQUATION_FUNC_REVERSE_SUBTRACT = NV097_SET_BLEND_EQUATION_V_FUNC_REVERSE_SUBTRACT,
    XGU_BLEND_EQUATION_MIN = NV097_SET_BLEND_EQUATION_V_MIN,
    XGU_BLEND_EQUATION_MAX = NV097_SET_BLEND_EQUATION_V_MAX,
    XGU_BLEND_EQUATION_FUNC_ADD_SIGNED = NV097_SET_BLEND_EQUATION_V_FUNC_ADD_SIGNED,
    XGU_BLEND_EQUATION_FUNC_REVERSE_SUBTRACT_SIGNED = NV097_SET_BLEND_EQUATION_V_FUNC_REVERSE_SUBTRACT_SIGNED
} XguBlendEquation;

typedef enum {
    XGU_SHADE_MODEL_FLAT = NV097_SET_SHADE_MODEL_FLAT,
    XGU_SHADE_MODEL_SMOOTH = NV097_SET_SHADE_MODEL_SMOOTH
} XguShadeModel;
...
XGU_API
uint32_t *xgu_set_blend_equation(uint32_t* p, XguBlendEquation eq) {
    return push_command_parameter(p, NV097_SET_BLEND_EQUATION, eq);
}

XGU_API
uint32_t* xgu_set_edge_flag_enable(uint32_t* p, bool enabled) {
    return push_command_boolean(p, NV097_SET_EDGE_FLAG, enabled);
}

XGU_API
uint32_t *xgu_set_shade_model(uint32_t* p, XguShadeModel model) {
    return push_command_parameter(p, NV097_SET_SHADE_MODEL, model);
}
